...
def main():
    ...
    train_val_src_dir = "/playpen-storage/levlevi/contextualized-shot-quality-analysis/data/experiments/train-sets/result-hidden/raw_clips/06_2_24_mean_err_30"
    ...
    dst_dir = "/playpen-storage/levlevi/contextualized-shot-quality-analysis/data/experiments/train-sets/result-hidden/formatted_datasets/oprime/noisey_vs_clean_data_ablation/nba_30k_bal_480_mean_err_30"
    ...
    copy_and_split_dataset(
        ...
        # class_balance=[0.4529, 0.5471], # DEFAULT: [50/50]
    )
